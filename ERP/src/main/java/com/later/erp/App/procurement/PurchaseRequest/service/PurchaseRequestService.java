package com.later.erp.App.procurement.PurchaseRequest.service;

import com.later.erp.Authorization.Security.Auth.entities.Employee;
import com.later.erp.App.company.employees.model.EmployeeShortModel;
...
import com.later.erp.App.procurement.PurchaseRequest.model.PurchaseRequestCreationModel;
import com.later.erp.App.procurement.PurchaseRequest.model.PurchaseRequestDetailsCreationModel;
import com.later.erp.App.procurement.PurchaseRequest.model.PurchaseRequestShortModel;
import com.later.erp.App.procurement.PurchaseRequest.repository.PurchaseRequestDetailsRepo;
import com.later.erp.App.procurement.PurchaseRequest.repository.PurchaseRequestRepo;
...
import com.later.erp.CommonModules.company.department.service.DepartmentService;
import com.later.erp.CommonModules.company.division.entity.Division;
import com.later.erp.CommonModules.company.division.service.DivisionService;
...
import com.later.erp.constants.ApprovalSpecialConditions;
...
public class PurchaseRequestService {
    ...
    public String create(PurchaseRequestCreationModel purchaseRequestCreationModel, Employee loginUser) throws ApiException {
        ...
        if (procurementActiveApprovals == null) {
            ...
            com.later.erp.App.company.employees.entity.Employee employee = employeeService.findById(purchaseRequestCreationModel.getBuyer());
    ...
    public List<CostCenter> getCostCenters(Employee loginUser) {
        ...
        for (ProcurementApprovalSpecialCondition asc : approvalSpecialConditions) {
            if (asc.getActive() && asc.getTypeId().equals(ApprovalSpecialConditions.SELECT_BUYER.id())) {
                if (map.containsKey("buyer")) {
                    com.later.erp.App.company.employees.entity.Employee employee = employeeService.findById(Long.parseLong(map.get("buyer")));
                    if (employee == null) {
