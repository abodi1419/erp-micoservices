...
public class PurchaseOrder implements WithApproval, HasAttachment, CostCenterInterface, DepartmentInterface, DivisionInterface, CreatedByInterface, CurrencyInterface {
    @Id
