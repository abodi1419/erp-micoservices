package com.later.inventoryservice.CommonModules.addresses.service;


import com.later.inventoryservice.CommonModules.addresses.entity.City;
import com.later.inventoryservice.CommonModules.addresses.entity.Country;
import com.later.inventoryservice.CommonModules.addresses.model.CityModel;
import com.later.inventoryservice.CommonModules.banks.entity.Bank;
...
public class AddressService {
    ...
    public List<City> findAllCities() {
        ...
        ResponseEntity<ApiResponse<List<City>>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list",
                HttpMethod.GET,
                null,
    ...
    public City findCityById(Long cityId) throws ApiException {
        ResponseEntity<ApiResponse<City>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list?cityId=" + cityId,
                HttpMethod.GET,
                null,
    ...
    public Country findCountryById(Long countryId) throws ApiException {
        ResponseEntity<ApiResponse<Country>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list?id=" + countryId,
                HttpMethod.GET,
                null,
    ...
    public City findCityByIdOrElseNull(Long id) throws ApiException {
        ResponseEntity<ApiResponse<City>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list?cityId=" + id,
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<ApiResponse<City>>() {
                }
    ...
    public Country findCountryByIdOrElseNull(Long id) throws ApiException {
        ResponseEntity<ApiResponse<Country>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list?id=" + id,
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<ApiResponse<Country>>() {
                }
    ...
    public List<CityModel> findAllCitiesByCountryId(Long countryId) {
        ResponseEntity<ApiResponse<List<CityModel>>> response = restTemplate.exchange(
                "http://common-service/api/v1/common/address/city/list?countryId=" + countryId,
                HttpMethod.GET,
                null,
