...
import com.later.supplierservice.App.suppliers.supplier.model.SupplierContactListModel;
...
public interface SupplierContactRepo extends JpaRepository<SupplierContact, Long> {
    ...
    @Query("select new com.later.supplierservice.App.suppliers.supplier.model.SupplierContactListModel(sc.id, sc.contactName, sc.contactNameAr, " +
