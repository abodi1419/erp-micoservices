...
import com.later.supplierservice.App.suppliers.DocumentService.service.SupplierDocumentService;
...
import com.later.supplierservice.App.suppliers.supplier.model.validation.SupplierCertificateCreationModel;
...
public class SupplierCertificateService {
    ...
    public DocumentModel downloadCertificate(Long id, String fileName) throws ApiException {
        ...
        SupplierDocument doc = supplierCertificate.getDocuments().stream().filter(d -> d.getFileName().equals(fileName))
